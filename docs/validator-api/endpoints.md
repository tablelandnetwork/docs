...
Transform the `/query` endpoint response to a specific format (it o**nly applies** to this \***\*endpoint)**.\*\*
...
[https://codesandbox.io/embed/red-surf-6bnbmm?fontsize=14&hidenavigation=1&theme=dark&view=preview](https://codesandbox.io/embed/red-surf-6bnbmm?fontsize=14&hidenavigation=1&theme=dark&view=preview)
